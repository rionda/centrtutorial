...
\frame{
  ...
  \begin{itemize}
    \item Social network analysis is the study of social entities and their interactions and relationships.
      ...
      \begin{itemize}
        \pause  \item each vertex (or vertex) represents an actor and
        \pause  \item each link represents a relationship.
    \end{itemize}
    \pause \item From the network, we can study the properties of its structure,
...
\frame{
  ...
  \begin{enumerate}
    ...
    \pause\item the vertex that maximizes the dominant eigenvector of the graph matrix;
...
\frame{
  ...
  Definition:
  \begin{itemize}
    \item closeness centrality $\closeness(x)$ of a  user $x$
      $$
...
\frame{
  ...
  \begin{columns}[T]
    \begin{column}{55mm}
      Definition:
      \begin{itemize}
        \item  betweenness centrality $\betw(x)$ of a user $x$:
          \[
    ...
    \end{column}
    \begin{column}{45mm}
      \includegraphics[width=42mm]{imgs/Graph_betweenness.png}
...
\frame{
  ...
  \begin{columns}[T]
    ...
    \hspace{-16mm}\begin{column}{40mm}
      \includegraphics[width=62mm]{imgs/weak_ties.png}
    \end{column}
  \end{columns}
}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=70mm]{imgs/facebook_graph.png}
  \end{center}
}
...
\frame{
  ...
  \includegraphics[width=50mm]{imgs/weak_ties2.png}
  \includegraphics[width=50mm]{imgs/weak_ties3.png}
}
...
\frame{
  ...
  \medskip
  \centering
  \includegraphics[width=82mm]{imgs/gn.png}
}
...
\frame{
  ...
  \end{block}
  \centering
  \includegraphics[width=100mm]{imgs/centrality_comparison.png}
}
...
\frame{
  ...
  \centering
  \includegraphics[width=100mm]{imgs/centrality.png}
}
...
\frame{
  ...
  \medskip
  \centering
  \includegraphics[width=82mm]{imgs/sts.png}
}
...
\frame{
  ...
  \medskip
  \centering
  \includegraphics[width=82mm]{imgs/std.png}
}
...
\frame{
  ...
  \begin{tabular}{c}
    ...
    \includegraphics[width=\textwidth]{imgs/kendall2.png}\\
    \medskip \\
    .uk (May 2007 snapshot)\\
    \includegraphics[width=\textwidth]{imgs/kendal.png}\\
  \end{tabular}
}
