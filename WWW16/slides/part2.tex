...
%        \includegraphics[width=\textwidth, height=0.8\textheight, keepaspectratio]{imgs/green-algo}
        \includegraphics[width=0.5\textwidth, height=0.8\textheight, keepaspectratio, valign=t]{imgs/green-algo1}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item Changes in \paths confined to sub-dag rooted in $v$
        \item Changes in \dep spread above 
      \end{itemize}
    \end{column}
