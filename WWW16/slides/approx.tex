...
\begin{frame}
  \frametitle{Shattering and Compressing Networks for Betweenness Centrality}
  \centering
  \vfill
  {\huge A.~E.~Sar\i y\"uce, E.~Saule, K.~Kaya, \"U.~V.~\c{C}ataly\"urek}
  \vfill
...
\begin{frame}
  \frametitle{Fast approximation of centrality}
  \centering
  \vfill
  {\huge D.~Eppstein, J.~Wang}
  \vfill
  {\large Journal of Graph Algorithms and Applications (2004)}
\end{frame}

\begin{frame}
  \frametitle{Centrality Estimation in Large Networks}
  \centering
  \vfill
  {\huge U.~Brandes, C.~Pich}
  \vfill
  {\large International Journal of Bifurcation and Chaos (2007)}
\end{frame}

\begin{frame}
  \frametitle{Better Approximation of Betweenness Centrality}
  \centering
  \vfill
  {\huge R.~Geisberger, P.~Sanders, D.~Schultes}
  \vfill
  {\large ALENEX (2008)}
\end{frame}

\begin{frame}
  \frametitle{Fast Approximation of Betweenness Centrality through Sampling}
  \centering
  \vfill
  {\huge M.~Riondato, E.~M.~Kornaropoulos}
  \vfill
...
\begin{frame}
  \frametitle{ABRA: Approximating Betweennes Centrality in Static and Dynamic
  Graphs with Rademacher Averages}
  \centering
  \vfill
  {\huge M.~Riondato, E.~Upfal}
  \vfill
  {\large arXiv (2016)}
\end{frame}

\begin{frame}
  \frametitle{Fully-Dynamic Approximation of Betweenness Centrality}
  \centering
  \vfill
  {\huge E.~Bergamini, H.~Meyerhenke}
  \vfill
  {\large European Symposium on Algorithms (2015)}
\end{frame}

\begin{frame}
  \frametitle{Fully Dynamic Betweenness Centrality Maintenance on Massive
  Networks}
  \centering
  \vfill
  {\huge T.~Hayashi, T.~Akiba, Y.~Yoshida}
  \vfill
  {\large VLDB: Very Large Databases (2016)}
\end{frame}

\begin{frame}
  \frametitle{Incremental Algorithm for Updating Betweenness Centrality in
